          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Understand your skill gaps and get recommendations for growth.",
                available: false,
              },
            ].map((feature, i) => (
...
// ============================================================================
// PORTFOLIO VIEW (PRESERVED FUNCTIONALITY)
// ============================================================================
...
const Portfolio = ({ portfolioData, onEdit, onViewScore }: PortfolioProps) => (
  <div className="min-h-screen relative bg-neutral-950">
    ...
    <div className="relative z-10">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-display font-semibold text-lg text-neutral-100">{portfolioData.name || 'Portfolio'}</span>
          </div>
          <div className="flex items-center gap-3">
            {onViewScore && (
              <button onClick={onViewScore} className="btn-outline text-sm flex items-center gap-2">
      ...
      {/* Hero Section */}
      <section className="pt-40 pb-28 px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          {/* Profile Image */}
          <div className="relative inline-block mb-10 animate-scale-in">
            ...
            {portfolioData.profileImage ? (
              <img
                ...
                className="relative w-44 h-44 md:w-56 md:h-56 rounded-full object-cover ring-4 ring-neutral-800/50 shadow-2xl animate-scale-in"
              />
            ) : (
              <div className="relative w-44 h-44 md:w-56 md:h-56 rounded-full bg-gradient-to-br from-primary-400 to-accent-500 flex items-center justify-center shadow-2xl">
          ...
          {/* Name & Role */}
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-display font-bold tracking-tight text-neutral-100 mb-5 animate-slide-up">
          ...
          <div className="flex justify-center gap-4 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            {portfolioData.github && (
              <a
                ...
                className="w-14 h-14 rounded-2xl glass glass-hover flex items-center justify-center group"
              >
                <Github className="w-6 h-6 text-neutral-400 group-hover:text-neutral-100 transition-colors" />
              </a>
            )}
            {portfolioData.linkedin && (
              <a
                ...
                className="w-14 h-14 rounded-2xl glass glass-hover flex items-center justify-center group"
              >
                <Linkedin className="w-6 h-6 text-neutral-400 group-hover:text-accent-400 transition-colors" />
              </a>
            )}
            {portfolioData.email && (
              <a
                ...
                className="w-14 h-14 rounded-2xl glass glass-hover flex items-center justify-center group"
              >
                <Mail className="w-6 h-6 text-neutral-400 group-hover:text-primary-400 transition-colors" />
              </a>
            )}
          </div>
        </div>
      ...
      {portfolioData.about && (
        <section className="py-24 px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="card-premium p-10 lg:p-14 glow-gold animate-scale-in">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center">
                  <User className="w-6 h-6 text-neutral-950" />
                </div>
                <h2 className="text-3xl font-display font-bold text-neutral-100">About Me</h2>
              </div>
              <p className="text-xl text-neutral-300 leading-relaxed">{portfolioData.about}</p>
            </div>
          </div>
        </section>
      )}
        ...
        <section className="py-24 px-6 lg:px-8 border-t border-white/5">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-14">
              ...
              <h2 className="section-title text-neutral-100">Skills & Technologies</h2>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {portfolioData.skills.map((skill, index) => (
                <div
                  key={index}
                  className="px-7 py-4 rounded-2xl glass gradient-border-subtle text-lg font-medium text-neutral-200 animate-scale-in hover:scale-105 transition-transform cursor-default"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-14">
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-primary-500/10 border border-primary-500/20 mb-6">
                <FolderKanban className="w-7 h-7 text-primary-400" />
              </div>
              <h2 className="section-title text-neutral-100">Featured Projects</h2>
            </div>
              ...
              {portfolioData.projects.map((project, index) => (
                ...
                >
                  <div className="aspect-video relative overflow-hidden">
                    {project.image ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-neutral-800 to-neutral-900 flex items-center justify-center">
                        <FolderKanban className="w-16 h-16 text-neutral-700" />
                      </div>
                    )}
                    ...
                    {project.url && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="absolute top-4 right-4 w-11 h-11 rounded-xl glass flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white/10"
                      >
                  ...
                  <div className="p-7 space-y-4">
                    <h3 className="text-xl font-display font-bold text-neutral-100 group-hover:text-primary-300 transition-colors">
                      {project.title}
                    </h3>
                    <p className="text-neutral-400 leading-relaxed line-clamp-2">{project.description}</p>
      ...
      <section className="py-24 px-6 lg:px-8 border-t border-white/5">
        <div className="max-w-3xl mx-auto text-center">
          <div className="card-premium p-10 lg:p-14 glow-gold animate-scale-in">
            <h2 className="text-3xl md:text-4xl font-display font-bold text-neutral-100 mb-4">Let's Connect</h2>
            <p className="text-neutral-400 text-lg mb-10">Interested in working together? I'd love to hear from you.</p>
      ...
      <footer className="py-10 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-neutral-600 text-sm">
            Built with <span className="text-primary-400">CareerLaunch AI</span> - Turn your resume into a complete professional identity
          </p>
        </div>
      </footer>
    </div>
